...
protocol _AccountService {
    
    func signIn(request: Request, account: Account) throws -> Future<AccessDto>
    
    func signUp(request: Request, account: Account) throws -> Future<ResponseDto>
    
    func refreshToken(request: Request, refreshTokenDto: RefreshTokenDto) throws -> Future<AccessDto>
}

struct AccountService : _AccountService {
